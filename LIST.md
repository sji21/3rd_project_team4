...
- 검증 결과: 전체 테스트 188개 통과(스킵 2, 사전 존재하던 Windows 환경변수 길이 오류 2건은 `tests/test_pdf_extraction.py` 소관)·`pip check`·청크 규격 검사 통과(운영 코퍼스 165청크 = 법령 133·판례 26·안내 6, 실험용 샘플 135청크는 별도)
