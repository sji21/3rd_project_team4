...
| 방식 | Hit@1 | Hit@3 | Hit@5 | MRR | 실패 |
| --- | --- | --- | --- | --- | --- |
| BM25 (용어사전) | 76.0% | 96.0% | 96.0% | 0.847 | dev-008 |
| KURE-v1 | 80.0% | 88.0% | 96.0% | 0.860 | dev-003 |
| **Hybrid RRF** | **80.0%** | 92.0% | **100.0%** | **0.880** | **없음** |
...
`rrf_k`(5~100)와 `depth`(5~60)를 훑어본 결과 **Hit@5는 모든 설정에서 100%**였고
나머지 지표 차이는 문항 1~2개 수준이라 표준오차(3.9%p) 안이었습니다. 25문항에
맞춰 튜닝하지 않고 관례값 `rrf_k=60`, `depth=20`, 가중치 1:1을 씁니다.
